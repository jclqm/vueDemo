...
export const adminRouteMap = (url) => {
  const redirectUrl = '/admin' + url
  return (redirectUrl)
}

export const pmeRouteMap = (url) => {
  const redirectUrl = '/projectteambasedsurvey' + url
  return (redirectUrl)
}

export const seRouteMap = (url) => {
  const redirectUrl = '/systemsurvey' + url
  return (redirectUrl)
}

export const surveyRouteMap = (url) => {
  const redirectUrl = '' + url
  return (redirectUrl)
}

export const unionRouteMap = (url) => {
  const redirectUrl = '/union' + url
  return (redirectUrl)
}

export const eeRouteMap = (url) => {
  const redirectUrl = '/functionalteambasedsurvey' + url
  return (redirectUrl)
}
